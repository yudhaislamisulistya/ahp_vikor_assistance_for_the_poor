        ...
        <div class="row page-titles mx-0">
            <div class="col-sm-6 p-md-0">
                <div class="welcome-text">
                    ...
                    <span>Tambah Data Alternatif</span>
                </div>
            </div>
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="javascript:void(0)">Form</a></li>
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">Tambah Data Alternatif</a></li>
                </ol>
            </div>
        </div>
        <!-- row -->
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-header">
                        <h4 class="card-title">Form Tambah Data Alternatif</h4>
                    </div>
                    <div class="card-body">
                        <div class="basic-form">
                            <form action="{{route('postTambahDataAlternatif')}}" method="POST">
                                @csrf
